...
// Py: Some("KG6YJN!wv$!") != Pl: Some("KG6YJN")
#[test]
#[ignore]
fn parse_7f1e4271() {
    ParserTestCase{ 
      raw: b"DISCOF>APT314,RAZOR*,WIDE1*,WIDE2-1,qAS,GERLCH:/022526h4046.40N/11912.12W-347/001/KG6YJN|!P%K(#|!wv$!",
      packet_type: "location",
      packet_fmt: "uncompressed",
      src_callsign: "DISCOF",
      dst_callsign: Some("APT314"), 
      via_callsigns: vec!["RAZOR", "WIDE1", "WIDE2-1", "qAS", "GERLCH"],
      via_digied: vec![1, 1, 0, 0, 0],
      timestamp: Some(1528597526),
      latitude: Some(40.7733),
      longitude: Some(-119.2020),
      ambiguity: None,
      resolution: Some(Meters(0.1852)),
      messaging: None,
      symcode: Some('-'),
      symtable: Some('/'),
      course: Some(Degrees(347.0000)),
      speed: Some(KilometersPerHour(1.8520)),
      altitude: None,
      comment: Some("KG6YJN"),
   }.run();
}
